...
export default function App() {
  ...
  const handleBookingSubmit = (e) => {
    ...
    const message = `✨ *New VIP Reservation Request* ✨\n\n*Name:* ${name}\n*Contact:* ${phone}\n*Date:* ${date}\n*Special Requests:* ${requests}\n\nPlease confirm my luxury VIP experience at Nisarg Bar and Restaurant.`;
    const whatsappUrl = `https://wa.me/918080685316?text=${encodeURIComponent(message)}`;
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-[#E5E5E5] font-sans selection:bg-[#D4AF37] selection:text-[#000000] overflow-x-hidden cursor-none">
      ...
      <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-4">
        <a 
          href="https://wa.me/918080685316" target="_blank" rel="noopener noreferrer"
        ...
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16 flex justify-between items-center">
          <div className="flex items-center gap-4 cursor-pointer group" onClick={() => scrollTo('home')}>
            <div className="w-12 h-12 border border-[#D4AF37]/50 rounded-full flex items-center justify-center group-hover:border-[#D4AF37] transition-all duration-500 bg-[#0A0A0A]">
              <span className="font-cinzel text-[#D4AF37] text-2xl">N</span>
            </div>
          ...
          <FadeIn delay={200}>
            <div className="flex items-center gap-6 mb-8">
              ...
              <p className="font-sans uppercase tracking-[0.6em] text-[#D4AF37] text-[10px] md:text-xs drop-shadow-md flex items-center gap-4">
                <Star size={10} className="text-[#D4AF37]" /> Goa's Elite Nightlife <Star size={10} className="text-[#D4AF37]" />
              </p>
              <span className="w-16 h-[1px] bg-gradient-to-l from-transparent to-[#D4AF37]"></span>
            </div>
          </FadeIn>
          <FadeIn delay={400}>
            <h1 className="font-playfair text-7xl md:text-[110px] lg:text-[130px] font-extralight text-white mb-6 leading-[0.9] tracking-tight drop-shadow-2xl">
              Nisarg <br/>
              <span className="italic"><GoldText>Bar & Restaurant</GoldText></span>
            </h1>
          </FadeIn>
          <FadeIn delay={600}>
            <p className="font-sans text-gray-300 text-xs md:text-sm max-w-xl mx-auto mb-14 font-light tracking-[0.2em] uppercase leading-loose">
              Immerse yourself in Goa's most exclusive dining and nightlife destination.
            </p>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
            ...
            <FadeIn delay={200} className="lg:pr-12">
              ...
              <div className="font-sans text-gray-400 space-y-8 font-light text-sm md:text-base tracking-wide leading-relaxed">
                <p>
                  Nestled in the tranquil beauty of Goa, Nisarg is a sanctuary for the world's most discerning palates. We blend regal local traditions with avant-garde culinary techniques to curate a dining experience that transcends the ordinary.
                </p>
                <p>
                  From our exclusive handcrafted signature cocktails to our premium spirits collection, every detail is meticulously curated. Here, dining is not merely a meal; it is a grand theatrical performance of taste, nature, and elegance.
                </p>
              </div>
            </FadeIn>
          </div>
      ...
      <section id="opulence" className="py-32 md:py-48 bg-[#050505] relative border-y border-[#D4AF37]/10">
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
          <div className="text-center max-w-3xl mx-auto mb-24">
            <FadeIn>
              ...
              <p className="font-sans text-gray-400 font-light tracking-wide text-sm md:text-base">
                Indulge in our masterfully curated masterpieces, crafted with the world's rarest and most exquisite ingredients.
              </p>
            </FadeIn>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { title: "The Imperial Gold", desc: "Premium vodka, rare vermouth, and fresh citrus oils, elegantly garnished with 24K edible gold leaf.", price: "INR 2,500" },
              { title: "Nisarg Coastal Punch", desc: "A luxury botanical blend featuring locally sourced spices, aged premium rum, and fresh coconut water nectar.", price: "INR 1,800" },
              { title: "Grand Reserve Cognac", desc: "A century of refinement in a glass. Served in bespoke crystal glasses for the ultimate connoisseur.", price: "INR 12,000" }
            ].map((item, idx) => (
        ...
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <FadeIn className="order-2 lg:order-1">
              ...
              <h2 className="font-playfair text-5xl md:text-7xl text-white mb-10 leading-tight font-light">
                The Rhythm of <br/> <GoldText className="italic">Nisarg</GoldText>
              </h2>
      ...
      <section id="reviews" className="py-32 md:py-48 bg-[#050505] border-y border-[#D4AF37]/10">
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { name: "Aarav Sharma", role: "Elite Member", text: "An absolute triumph in fine dining. The attention to detail, from the ambient nature sounds to the flawless service, makes Nisarg peerless in Goa." },
              { name: "Sophia Laurent", role: "Travel Critic", text: "The luxury dining experience here was nothing short of cinematic. It is rare to find a place that matches its breathtaking ambiance with such culinary perfection." },
              { name: "Sheikh H.A.", role: "VIP Guest", text: "Unquestionably the most elegant lounge and restaurant in the state. The private reservation process was seamless, and the evening was an absolute masterpiece." }
            ].map((review, idx) => (
              <FadeIn key={idx} delay={idx * 200}>
              ...
              <div className="space-y-10">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="font-cinzel text-[#D4AF37] text-lg tracking-widest">+91 80806 85316</p>
                  </div>
                </div>
              </div>
            </FadeIn>
        ...
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
          ...
          <FadeIn delay={200}>
            <div className="w-full h-[400px] md:h-[500px] rounded-[40px] overflow-hidden border border-[#D4AF37]/40 shadow-[0_0_30px_rgba(212,175,55,0.25)] hover:shadow-[0_0_50px_rgba(212,175,55,0.5)] transition-shadow duration-700">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15391.337337337!2d74.2255!3d15.0848!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbe0fc538b9756b%3A0x6bcf27ad869ea56e!2sNetravali%2C%20Goa!5e0!3m2!1sen!2sin!4v1683620392341!5m2!1sen!2sin" 
                width="100%" 
                height="100%" 
        ...
        <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="font-sans text-gray-400 font-light text-sm tracking-wide max-w-sm mb-10 leading-relaxed">
                Goa's most exclusive destination for fine dining, luxury aesthetics, and world-class hospitality in nature's lap.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-6 font-sans text-gray-400 font-light text-sm tracking-wide">
                <li className="flex items-start gap-3"><MapPin size={16} className="text-[#D4AF37] shrink-0 mt-0.5" /> Neturlim, Netravli , Goa.</li>
                <li className="flex items-center gap-3"><Phone size={16} className="text-[#D4AF37] shrink-0" /> +91 80806 85316</li>
                <li className="flex items-center gap-3"><Clock size={16} className="text-[#D4AF37] shrink-0" /> Daily: 11:00 AM - 11:00 PM</li>
              </ul>
            </div>
          ...
          <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="font-sans text-gray-500 text-[10px] tracking-[0.2em] uppercase">
              &copy; {new Date().getFullYear()} Nisarg Goa. All Rights Reserved.
            </p>
